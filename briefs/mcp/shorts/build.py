...
PLAN = {
 '00': dict(slug='mcp-00-how-claude-works', beats=['s03','s04b'],
   cover=("ONE CALL, FOUR ARGS","Claude's API"),
   hook="If you've only used Claude through a chat box, the API underneath is simpler than you think.",
   outro="One call, four arguments — and MCP is what fills the last one. The full course is on the channel.",
   msg=("How Claude actually works","chapter one of twelve"),
   title="The Claude API In 90 Seconds (Before You Touch MCP)",
   tags=["claude api","anthropic","python","mcp","llm","api tutorial"]),
 ...
 '11': dict(slug='mcp-11-elicitation', beats=['s03','s04'],
 ...
 '10': dict(slug='mcp-12-everything', beats=['s03','s03b'],
