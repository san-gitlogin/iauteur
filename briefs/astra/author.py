...
beat(id="s01", type="HOOK", background="zoneA", _anchors=2,
  narration="One benchmark scored GPT-6 Astra ninety-nine point nine percent. The same test, the same day, scored it sixty-two point seven.",
...
beat(id="s06b", key="astraStage", type="ASTRA_STAGE", background="zoneB",
  ...
  stage=stage(
    {"label": "GPT-5.6 Sol", "text": "65.7%", "detail": "75 min", "value": 65.7},
...
beat(id="s09b", key="astraStage", type="ASTRA_STAGE", background="zoneC",
  ...
  stage=stage({"label": "tokens it can hold at once", "value": 1050000,
               "sub": "one million, fifty thousand"}))
...
beat(id="s22", key="astraStage", type="ASTRA_STAGE", background="zoneB",
  headline="Now put a [person on it]", kind="cost-plane", color="green",
  ...
  stage=stage(
    {"label": "a person", "value": 100, "text": "$12.78", "win": True},
    {"label": "Astra · standard", "value": 62.7, "text": "$26,098"},
...
beat(id="s23", key="astraStage", type="ASTRA_STAGE", background="zoneB",
  ...
  stage=stage(
    {"label": "a world it has never seen"},
...
beat(id="s25", key="astraStage", type="ASTRA_STAGE", background="zoneB",
  ...
  narration="And ARC Prize themselves are careful about what it means. ARC Prize call Astra a ^noticeable step-function change in frontier model capability — that is their phrase, and it isn't faint praise. In the same report they say ^saturating this benchmark would ^not represent proof of achieving AGI, and they point at the ^tightly bounded scope of the environments. ~So the people who built the test are the ones telling you where its edges are.",
  stage=stage(
    ...
    {"label": "measured against people", "sub": "the human baseline is published", "icon": "lucide:users", "win": True}))
...
beat(id="s46", key="astraStage", type="ASTRA_STAGE", background="zoneA",
  ...
  narration="Here is the shape of that thread, and the votes tell the story better than any quote. Six hundred and fifty-one people upvoted that ^post. Its top ^reply — here we go again, every few months a model gives a life-changing experience — took eleven hundred. ^Another asked whether people remember Devin, which was going to replace all software engineers three years ago. ^Two hundred and twenty-seven upvoted somebody who can't even find Astra yet. ~Weariness won that thread, because most of these people have watched this exact launch cycle before.",
  stage=stage(
...
beat(id="s51", key="astraStage", type="ASTRA_STAGE", background="zoneB",
  ...
  narration="Which brings us back to the question in the title. On one side, Astra ^operates software better than anything before it, and it ^invented its own notation to solve worlds nobody explained. On the other, it ^loses to Claude Fable 5.1 on expert reasoning and on the neutral index, and the people who own the ^benchmark say saturating it would not be proof of anything. ~My reading is that Astra is the best operator available, rather than the smartest model available, and those are genuinely different titles.",
  stage=stage(
    ...
    {"label": "not proof of AGI", "sub": "ARC Prize, in their own report", "icon": "lucide:shield-x"}))
