...
description: Use when the user wants a video, theme, or component set in the "Industrial" design style, asks for design variety suggestions for their Remotion video studio, or references this aesthetic. Provides the complete Industrial design language (colors, typography, principles) plus mandatory rules for adapting it into a video-safe Remotion theme per the studio's design contract.
---

# Industrial — Video Design Skill
