---
name: design-bauhaus
description: Use when the user wants a video, theme, or component set in the "Bauhaus" design style, asks for design variety suggestions for their Remotion video studio, or references this aesthetic. Provides the complete Bauhaus design language (colors, typography, principles) plus mandatory rules for adapting it into a video-safe Remotion theme per the studio's design contract.
---

# Bauhaus — Video Design Skill
