...
description: Use when the user wants a video, theme, or component set in the "Vaporwave" design style, asks for design variety suggestions for their Remotion video studio, or references this aesthetic. Provides the complete Vaporwave design language (colors, typography, principles) plus mandatory rules for adapting it into a video-safe Remotion theme per the studio's design contract.
---

# Vaporwave — Video Design Skill
