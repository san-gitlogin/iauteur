---
name: design-academia
description: Use when the user wants a video, theme, or component set in the "Academia" design style, asks for design variety suggestions for their Remotion video studio, or references this aesthetic. Provides the complete Academia design language (colors, typography, principles) plus mandatory rules for adapting it into a video-safe Remotion theme per the studio's design contract.
---

# Academia — Video Design Skill
