---
name: design-modern-dark
description: Use when the user wants a video, theme, or component set in the "Modern Dark" design style, asks for design variety suggestions for their Remotion video studio, or references this aesthetic. Provides the complete Modern Dark design language (colors, typography, principles) plus mandatory rules for adapting it into a video-safe Remotion theme per the studio's design contract.
---

# Modern Dark — Video Design Skill
