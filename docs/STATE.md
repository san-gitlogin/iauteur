...
**Not yet started:** the beat maps, `cast.mjs`, any component, any spec. The plan names two open
decisions for the owner (whether a stitched `uv-course` cut is wanted, and whether chapter 01 is
folded into 00 since installation alone will not carry a 5:00 floor).
