...
export interface ModelShrugItem {
  label?: string;
  text?: string;
  title?: string;
  sub?: string;
...
export interface ModelShrugData {
  headline?: string;
  needle?: string;
  saidLabel?: string;
  missedLabel?: string;
  said?: ModelShrugItem[];
  missed?: ModelShrugItem[];
  verdict?: string;
  verdictAtWord?: number;
  source?: string;
  atWord?: number;
...
export interface ColumnSplitItem {
  label?: string;
  text?: string;
  title?: string;
  sub?: string;
...
export interface ColumnSplitData {
  headline?: string;
  tableName?: string;
  columns?: ColumnSplitItem[];
  rows?: ColumnSplitItem[];
  splitAtWord?: number;
  left?: ColumnSplitItem[];
  right?: ColumnSplitItem[];
  question?: string;
  askAtWord?: number;
  gapNote?: string;
  source?: string;
