...
// CMD_LN — `ln` on the two-up command stage.
// LEFT: a live terminal types each step on the word it is spoken.
// RIGHT: fs-inode — One data block on the right with named arrows pointing at it and a live link counter.
//
...
export const CmdLn: React.FC<{scene: Scene}> = ({scene}) => {
  const {scale, vertical} = useScale();
  const d = scene.data.cmdLn;
