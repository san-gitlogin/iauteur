...
// CMD_TOUCH — `touch` on the two-up command stage.
// LEFT: a live terminal types each step on the word it is spoken.
// RIGHT: file-clocks — A file card carrying a byte counter and two real clock faces labelled modify and access.
//
...
export const CmdTouch: React.FC<{scene: Scene}> = ({scene}) => {
  const {scale, vertical} = useScale();
  const d = scene.data.cmdTouch;
