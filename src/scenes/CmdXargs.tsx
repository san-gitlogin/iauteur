...
// CMD_XARGS — `xargs` on the two-up command stage.
// LEFT: a live terminal types each step on the word it is spoken.
// RIGHT: pipe-flow — A pipe drawn as a real channel between two programs.
//
...
export const CmdXargs: React.FC<{scene: Scene}> = ({scene}) => {
  const {scale, vertical} = useScale();
  const d = scene.data.cmdXargs;
