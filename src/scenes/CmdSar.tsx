...
// CMD_SAR — `sar` on the two-up command stage.
// LEFT: a live terminal types each step on the word it is spoken.
// RIGHT: gauge-board — A calendar strip of stored days beneath the graph.
//
...
export const CmdSar: React.FC<{scene: Scene}> = ({scene}) => {
  const {scale, vertical} = useScale();
  const d = scene.data.cmdSar;
