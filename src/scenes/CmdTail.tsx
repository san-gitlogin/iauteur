...
// CMD_TAIL — `tail` on the two-up command stage.
// LEFT: a live terminal types each step on the word it is spoken.
// RIGHT: file-content — The document panel is pinned to the bottom of the file.
//
...
export const CmdTail: React.FC<{scene: Scene}> = ({scene}) => {
  const {scale, vertical} = useScale();
  const d = scene.data.cmdTail;
