...
// CMD_USERADD — `useradd` on the two-up command stage.
// LEFT: a live terminal types each step on the word it is spoken.
// RIGHT: fs-writes — Four system files drawn as real cards.
//
...
export const CmdUseradd: React.FC<{scene: Scene}> = ({scene}) => {
  const {scale, vertical} = useScale();
  const d = scene.data.cmdUseradd;
