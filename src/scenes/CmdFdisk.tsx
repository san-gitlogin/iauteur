...
// CMD_FDISK — `fdisk` on the two-up command stage.
// LEFT: a live terminal types each step on the word it is spoken.
// RIGHT: partition-map — The disk drawn as a single continuous bar carved into partitions.
//
...
export const CmdFdisk: React.FC<{scene: Scene}> = ({scene}) => {
  const {scale, vertical} = useScale();
  const d = scene.data.cmdFdisk;
