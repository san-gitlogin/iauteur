...
// CMD_ATOP — `atop` on the two-up command stage.
// LEFT: a live terminal types each step on the word it is spoken.
// RIGHT: gauge-board — A timeline scrubber sitting beneath the gauges.
//
...
export const CmdAtop: React.FC<{scene: Scene}> = ({scene}) => {
  const {scale, vertical} = useScale();
  const d = scene.data.cmdAtop;
