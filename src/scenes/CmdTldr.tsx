...
// CMD_TLDR — `tldr` on the two-up command stage.
// LEFT: a live terminal types each step on the word it is spoken.
// RIGHT: manual-sections — The full manual page is drawn at true relative length beside the tldr page, so the 1,241 lines against 8 is a proportion you see rather than a figure you are told.
//
...
export const CmdTldr: React.FC<{scene: Scene}> = ({scene}) => {
  const {scale, vertical} = useScale();
  const d = scene.data.cmdTldr;
