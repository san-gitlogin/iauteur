...
// CMD_PSTREE — `pstree` on the two-up command stage.
// LEFT: a live terminal types each step on the word it is spoken.
// RIGHT: proc-tree — Processes drawn as a real parent-child graph with connecting lines.
//
...
export const CmdPstree: React.FC<{scene: Scene}> = ({scene}) => {
  const {scale, vertical} = useScale();
  const d = scene.data.cmdPstree;
