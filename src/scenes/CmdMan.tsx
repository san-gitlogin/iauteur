...
// CMD_MAN — `man` on the two-up command stage.
// LEFT: a live terminal types each step on the word it is spoken.
// RIGHT: manual-sections — The manual is drawn as numbered shelves rather than one book.
//
...
export const CmdMan: React.FC<{scene: Scene}> = ({scene}) => {
  const {scale, vertical} = useScale();
  const d = scene.data.cmdMan;
