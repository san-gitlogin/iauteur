...
// CMD_VMSTAT — `vmstat` on the two-up command stage.
// LEFT: a live terminal types each step on the word it is spoken.
// RIGHT: gauge-board — Rows arrive on a ticking interval.
//
...
export const CmdVmstat: React.FC<{scene: Scene}> = ({scene}) => {
  const {scale, vertical} = useScale();
  const d = scene.data.cmdVmstat;
