...
// CMD_RM — `rm` on the two-up command stage.
// LEFT: a live terminal types each step on the word it is spoken.
// RIGHT: delete-gate — The tree sits behind a delete gate.
//
...
export const CmdRm: React.FC<{scene: Scene}> = ({scene}) => {
  const {scale, vertical} = useScale();
  const d = scene.data.cmdRm;
