...
// CMD_BTOP — `btop` on the two-up command stage.
// LEFT: a live terminal types each step on the word it is spoken.
// RIGHT: gauge-board — Real sparkline graphs plotting the last sixty seconds.
//
...
export const CmdBtop: React.FC<{scene: Scene}> = ({scene}) => {
  const {scale, vertical} = useScale();
  const d = scene.data.cmdBtop;
