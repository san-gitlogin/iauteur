...
// CMD_CRON — `cron` on the two-up command stage.
// LEFT: a live terminal types each step on the word it is spoken.
// RIGHT: sched-clock — The five fields are drawn above a real clock and calendar.
//
...
export const CmdCron: React.FC<{scene: Scene}> = ({scene}) => {
  const {scale, vertical} = useScale();
  const d = scene.data.cmdCron;
