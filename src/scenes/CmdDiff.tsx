...
// CMD_DIFF — `diff` on the two-up command stage.
// LEFT: a live terminal types each step on the word it is spoken.
// RIGHT: text-compare — Two file columns aligned line for line.
//
...
export const CmdDiff: React.FC<{scene: Scene}> = ({scene}) => {
  const {scale, vertical} = useScale();
  const d = scene.data.cmdDiff;
