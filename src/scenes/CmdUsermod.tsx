...
// CMD_USERMOD — `usermod` on the two-up command stage.
// LEFT: a live terminal types each step on the word it is spoken.
// RIGHT: group-sets — The user's groups drawn as a real set of chips.
//
...
export const CmdUsermod: React.FC<{scene: Scene}> = ({scene}) => {
  const {scale, vertical} = useScale();
  const d = scene.data.cmdUsermod;
