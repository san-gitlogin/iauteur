...
// CMD_CHEAT — `cheat` on the two-up command stage.
// LEFT: a live terminal types each step on the word it is spoken.
// RIGHT: manual-sections — A third shelf appears beside the manual and tldr: one you write yourself.
//
...
export const CmdCheat: React.FC<{scene: Scene}> = ({scene}) => {
  const {scale, vertical} = useScale();
  const d = scene.data.cmdCheat;
