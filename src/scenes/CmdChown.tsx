...
// CMD_CHOWN — `chown` on the two-up command stage.
// LEFT: a live terminal types each step on the word it is spoken.
// RIGHT: perm-switches — The same nine switches, but frozen and greyed to show they never move.
//
...
export const CmdChown: React.FC<{scene: Scene}> = ({scene}) => {
  const {scale, vertical} = useScale();
  const d = scene.data.cmdChown;
