...
// CMD_UPTIME — `uptime` on the two-up command stage.
// LEFT: a live terminal types each step on the word it is spoken.
// RIGHT: load-cores — Load is drawn against a real row of core slots.
//
...
export const CmdUptime: React.FC<{scene: Scene}> = ({scene}) => {
  const {scale, vertical} = useScale();
  const d = scene.data.cmdUptime;
