...
// CMD_CAT — `cat` on the two-up command stage.
// LEFT: a live terminal types each step on the word it is spoken.
// RIGHT: file-content — A document panel holding the real file.
//
...
export const CmdCat: React.FC<{scene: Scene}> = ({scene}) => {
  const {scale, vertical} = useScale();
  const d = scene.data.cmdCat;
