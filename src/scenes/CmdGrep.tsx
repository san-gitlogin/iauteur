...
// CMD_GREP — `grep` on the two-up command stage.
// LEFT: a live terminal types each step on the word it is spoken.
// RIGHT: file-content — The document panel holds the whole log.
//
...
export const CmdGrep: React.FC<{scene: Scene}> = ({scene}) => {
  const {scale, vertical} = useScale();
  const d = scene.data.cmdGrep;
